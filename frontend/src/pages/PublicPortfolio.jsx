...
export default function PublicPortfolio() {
    ...
    const closePrivacyPanel = () => {
        if (privacyChoice) setPrivacyPanelOpen(false);
        else choosePrivacy(PRIVACY_CHOICES.ESSENTIAL);
    };
