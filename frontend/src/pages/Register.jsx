    ...
    return <main className={`auth-page ${otpRequested ? "verify-account-page" : ""}`}><div className="auth-card">
        ...
        {!otpRequested ? <>
            ...
            <form className="auth-form" onSubmit={submitDetails} noValidate>
                ...
                <label className="legal-acceptance"><input type="checkbox" checked={acceptedLegal} onChange={(event) => setAcceptedLegal(event.target.checked)} /><span>I have read and agree to the <Link to="/terms" target="_blank" rel="noopener noreferrer">Terms</Link> and acknowledge the <Link to="/privacy" target="_blank" rel="noopener noreferrer">Privacy Policy</Link>.</span></label>
